...
// --- HELPER BUILD BUTTON (KODE DARI TEMEN LU) ---
...
bot.start(async (ctx) => {
    ...
    ctx.reply(welcomeText, { 
        ...
        ...Markup.inlineKeyboard([
            ...
            [
                buildBtn('🗑️ TUTUP MENU', 'action_close', 'danger')
            ]
        ])
    });
...
[Result] Terkumpul: ${allResults.length} / ${targetTotal} Sesi</pre>`;
        ...
        if (allResults.length > 0) {
            ...
            const summaryLayout = 
                ...
                `Sistem telah menyelesaikan tugas dengan sukses. Jika Anda membutuhkan standarisasi format atau verifikasi live/dead lanjutan, silakan teruskan file output di bawah ini ke bot manajemen @corvastcookie_bot agar diproses lebih lanjut.`;
            ...
            await ctx.replyWithDocument(
                { source: fileBuffer, filename: 'Corvast_Extracted_Live.txt' }, 
